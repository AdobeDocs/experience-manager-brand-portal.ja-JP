...
+ 概要 {#introduction} {#introduction}
   + [概要](/help/using/brand-portal.md)
   + [Experience Manager Assets Brand Portal の新機能](/help/using/whats-new.md)
   ...
   + [Experience Manager Assets と Brand Portal について](https://experienceleague.adobe.com/ja/docs/experience-manager-brand-portal/using/home)
   + [Brand Portal でのアセットの参照](/help/using/browse-assets-brand-portal.md)
+ Experience Manager Assets から Brand Portal への公開 {#publish} {#publish}
...
+ Brand Portal でのアセットソーシング {#asset-sourcing-in-brand-portal} {#asset-sourcing-in-brand-portal}
...
+ 管理ツールの使用 {#admin-tools} {#admin-tools}
